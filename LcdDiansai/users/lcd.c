...
//屏幕像素240 * 320
//使用160*160 从0，0开始开始 80.80为中心
//物理长 160*160
void LCD_DrawPoint_angle(float len,float angle)
{
	float x = 0;
	float y = 0;

	//  if(angle>=0 && angle<=90){
		x = ((len*1000/10) * cos(angle*PI/180)) + 80;
		y = 80 - ((len*1000/10) * sin(angle*PI/180));
	// }
	// else if(angle>90 && angle<=180){
	// 	x = 80 +(len * 100 * cos(angle));
	// 	y = 80 - (len * 100 * sin(angle));
	// }
	...
	//LCD_Color_Fill(x * 100 -1, y *100 -1, x * 100 +1, y * 100 +1, BLACK);
}


void LCD_DrawLine_angles(float len1, float angle1, float len2, float angle2)
{
	float x1 = len1*100;
	float y1 = angle1;
	float x2 = len2*100;
	...
	x1 = (len1*100 * cos(angle1))+80;
	y1 = 80 - (len1*100 * sin(angle1));

	x2 = (len2*100 * cos(angle2))+80;
	y2 = 80 - (len2*100 * sin(angle2));
